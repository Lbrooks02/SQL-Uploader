...
def Validate_Data(*functionParameters: str) -> bool:    #Validate data format of required parameters
    ...
    def _Error_Handler(errorMessage: str, forceQuit: bool = True, playSound: bool = True):  #Prints error message + quits/returns success status (helper sub-function)
    ...
    callerFunctionObject = callerFunctionFrame.f_globals.get(callerFunctionName)    #Get the calling function's object 
    if callerFunctionObject:
